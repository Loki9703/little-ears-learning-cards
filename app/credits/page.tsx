  ...
  return (
    <main style={{ maxWidth: 760, margin: "0 auto", padding: "36px 22px 64px", color: "#493e30", fontFamily: "system-ui, sans-serif", lineHeight: 1.7 }}>
      ...
      <ul style={{ paddingLeft: 22 }}>
        ...
        <li style={{ margin: "10px 0" }}>
          动态卡片及消防场景中的火焰使用 <a href="https://googlefonts.github.io/noto-emoji-animation/" target="_blank" rel="noreferrer" style={{ color: "#a35d2d" }}>Google Animated Noto Emoji</a>，动画资源使用 <a href="https://creativecommons.org/licenses/by/4.0/legalcode" target="_blank" rel="noreferrer" style={{ color: "#a35d2d" }}>CC BY 4.0</a>。
        </li>
        <li style={{ margin: "10px 0" }}>
